...
class ReadMe(object):
    ...
    def regenerate(self):
        ...
        with open(self.filename, 'a') as f:
            ...
            f.write("[![Star History Chart](https://api.star-history.com/svg?repos=trinitUnsalted/AdRules&type=Date)](https://www.star-history.com/#trinitUnsalted/AdRules&Date)\n")
